...
import dashboardImage from "@assets/bank-rec/portal/dashboard/dashboard.png";

The dashboard should be your first stop when checking what Otto's been up to recently.

<ZoomableImage src={dashboardImage} alt="Screenshot of the dashboard page" />
...
<Aside type="tip" title="Related pages">
  - [Feedback](/bank-rec/guides/feedback) - Review what Otto did that day for
  the client and let him know how he did
</Aside>
