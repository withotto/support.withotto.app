...
import reconciliationMatchImage from "@assets/bank-rec/guides/how-does-otto-decide-what-to-reconcile/reconciled.png";

Before he starts his reconciliation work for a client, Otto is shown examples of previous reconciliations for that client. We give him the direction on what information he should look at so he can understand how to tell _why_ that bank transaction matched the bill or invoice.
...
<Image src={reconciliationMatchImage} alt="Example of a reconciliation match" />
...
You can tell Otto whether the items are a match or not using the buttons. This is always used to improve his performance when he is next trained but can also cause other things to happen. See [feedback](/bank-rec/guides/feedback) for more information.

<Aside type="tip" title="Related pages">
  - [GuidedMatch](/bank-rec/guides/guidedmatch) -
  [SmartMatch](/bank-rec/guides/smartmatch) - [Practice and client
  settings](/bank-rec/portal/settings) - [Feedback](/bank-rec/guides/feedback) -
  Letting Otto know when he's right or wrong
</Aside>
