...
The last part of the call is where we'll help you invite Otto to your practice and agree a convenient time to start the trial.

## Post-call steps

We'll set up everything on our side after the call. You'll then be able to assign the clients you would like to start your trial with. You can change the clients at any time so don't worry if you're not sure which ones would be best.

There's nothing more for you to do until your trial starts. We'll begin training Otto on one year's worth of reconciliation data for each of the assigned clients. This is his starting knowledge to decide whether a bank transaction and a bill or invoice relate to the same payment.
...
<Aside type="tip" title="Related pages">
  - [Book a free trial and onboarding call](https://withotto.app/trial/)
</Aside>
