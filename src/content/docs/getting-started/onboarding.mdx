...
## Otto's first day
Otto will only reconcile bank transactions to begin with. This is to let you review his SmartMatch predictions to make sure you're happy with his work before you let him reconcile green matches. You can enable SmartMatch at any time, and even pick and choose which clients to enable it for.
