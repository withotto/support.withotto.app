...
<Steps>
    ...
    3. Give feedback
        ...
        feedback from you. We perform a extra re-training around two weeks into the trial so you can see the difference
...
<Aside type="tip" title="Related pages">
    ...
    - [Settings](../../guides/settings/) - enable reconciliation features for all or some of your clients
</Aside>
