...
The feedback will always be used to make Otto more accurate in future but some other things can happen depending on the action he took and the type of feedback you give.
...
2. Undo the mistake he made in Xero.

We don't want to make the situation worse so Otto now won't touch that bank statement transaction, even if another bill or invoice becomes available in future. You will need to reconcile the match yourself in Xero.

<Aside>
    Incorrect SmartMatch reconciliations are not charged and do not count against your included credits. We only want
    you to pay when Otto is doing what you want him to.
</Aside>
...
<Aside>
    There is no charge for GuidedMatch reconciliations.
</Aside>
