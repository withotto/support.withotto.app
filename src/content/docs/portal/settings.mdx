...
### Practice-wide
<ClickableImage src={practiceReconciliationSettingsImage} alt="Screenshot of the reconciliation settings for a practice" />
...
### Client-specific
<ClickableImage src={clientReconciliationSettingsImage} alt="Screenshot of the reconciliation settings for a client" />
...
## Scheduling
<ClickableImage src={schedulingSettingsImage} alt="Screenshot of the scheduling settings for a client" />
...
You can let Otto reconcile more than your included credits by specifying a extra credits limit. For example, if your plan includes 500 credits and you allow 100 extra credits, Otto will stop until the next billing period if he consumes 600 credits.
