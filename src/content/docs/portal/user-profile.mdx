...
<ClickableImage src={profileLinksImage} alt="Screenshot of the profile menu with a link to the settings page" />
...
After updating your information, simply click the "Save" button in the bottom-right corner. If you need to return to your work without making changes, click "Back to dashboard".
