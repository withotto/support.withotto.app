...
<ClickableImage src={clientsListImage} alt="Screenshot of the clients list page" />
...
<ClickableImage src={clientDetailsImage} alt="Screenshot of the client details page" />
