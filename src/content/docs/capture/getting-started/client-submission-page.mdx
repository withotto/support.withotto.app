...
import submissionPagePhone from "@assets/capture/getting-started/client-submission-page/submission-page-phone.png";
...
<ZoomableImage
  ...
  label="Client submission settings"
  caption="Anyone in your organisation can copy the link; rotating it and turning the page off are admin-only."
/>
...
<ZoomableImage
  src={submissionPage}
  alt="The client submission page as the sender sees it, headed Send documents to Willowbrook Accountants, naming the client it sends for, with a Choose files area and a What happens next section"
  label="Client submission page"
  caption="The page names your organisation and the client, so whoever opens it can see it's the right one."
  phoneSrc={submissionPagePhone}
  phoneAlt="The same page on a phone, with the heading, the Choose files area and the What happens next section stacked down the screen"
  phoneCaption="Most senders open this on a phone, where the picker takes the full width."
/>
