...
By default, each client receives documents at an address like `{prefix}@{your-organisation}.ottocapture.email`. You can configure a custom domain so clients receive documents at addresses on your own domain instead. For example, `acme@docs.smithaccounting.com`. This gives you complete control of the branding your clients see, and helps them tell they are forwarding their documents to a legitimate service.
