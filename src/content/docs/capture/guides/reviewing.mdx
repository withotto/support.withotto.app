...
A client's documents are split across tabs: **Needs attention**, **Ready**, **Processing**, **Published**, **Discarded**, and **Sales invoices**. On the **Needs attention** and **Ready** tabs you can discard in bulk: select the documents with their checkboxes, click **Discard selected**, then confirm. This clears a batch of duplicates or test uploads in one go.
