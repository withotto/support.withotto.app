...
- Override the default state (Draft, Awaiting approval, or Awaiting payment) for this specific document
...
The bill is created in the state you selected (Draft, Awaiting approval, or Awaiting payment).
